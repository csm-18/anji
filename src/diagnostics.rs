...
/// If user sets the env variable then funny_comments are printed along side diagnostic messages.
static ANJI_DIAGNOSTIC_COMMENTS: LazyLock<bool> =
    LazyLock::new(|| host::get_env_variable("ANJI_DIAGNOSTIC_COMMENTS"));
